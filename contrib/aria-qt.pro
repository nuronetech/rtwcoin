...
RESOURCES += src/qt/aria.qrc src/qt/aria_locale.qrc

TRANSLATIONS += src/qt/locale/aria_bg.ts \
                src/qt/locale/aria_de.ts \
                src/qt/locale/aria_en.ts \
                src/qt/locale/aria_es.ts \
                src/qt/locale/aria_fi.ts \
                src/qt/locale/aria_fr.ts \
                src/qt/locale/aria_it.ts \
                src/qt/locale/aria_ja.ts \
                src/qt/locale/aria_pl.ts \
                src/qt/locale/aria_pt.ts \
                src/qt/locale/aria_ru.ts \
                src/qt/locale/aria_sk.ts \
                src/qt/locale/aria_sv.ts \
                src/qt/locale/aria_vi.ts \
                src/qt/locale/aria_zh_CN.ts \
                src/qt/locale/aria_zh_TW.ts
