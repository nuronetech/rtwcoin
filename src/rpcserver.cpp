...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AriA features */
        {"aria", "masternode", &masternode, true, true, false},
        {"aria", "listmasternodes", &listmasternodes, true, true, false},
        {"aria", "getmasternodecount", &getmasternodecount, true, true, false},
        {"aria", "masternodeconnect", &masternodeconnect, true, true, false},
        {"aria", "masternodecurrent", &masternodecurrent, true, true, false},
        {"aria", "masternodedebug", &masternodedebug, true, true, false},
        {"aria", "startmasternode", &startmasternode, true, true, false},
        {"aria", "createmasternodekey", &createmasternodekey, true, true, false},
        {"aria", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"aria", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"aria", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"aria", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"aria", "getmasternodescores", &getmasternodescores, true, true, false},
        {"aria", "mnbudget", &mnbudget, true, true, false},
        {"aria", "preparebudget", &preparebudget, true, true, false},
        {"aria", "submitbudget", &submitbudget, true, true, false},
        {"aria", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"aria", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"aria", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"aria", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"aria", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"aria", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"aria", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"aria", "checkbudgets", &checkbudgets, true, true, false},
        {"aria", "mnsync", &mnsync, true, true, false},
        {"aria", "spork", &spork, true, true, false},
        {"aria", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"aria", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ariad, or the -server option to aria-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"AriA Alert\" support@nur1labs.com\n"),
...
{
    return "> aria-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:14671/\n";
}
