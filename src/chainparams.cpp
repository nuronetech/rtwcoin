...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x906a42e00da09beb034fa6d530091e506705bd87a630bdeac334f98e2db87b36")) //Starting Point
    (10, uint256("0x000004ade1a9e0d0ff68b82739d5b29b96cb7d457b0a6fa56f75e168e54b0c73")) //Explorer Rebuild
    (353, uint256("0x0000011ef9cde5f5be5cbf878227ce0346127aa7209ca25ac8d6f22a1016ef68")); //Added Pools
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04cc45c8a41b7868f9b4c536e2a99cf279483d312d8a6a115166cbe26244eaddb6b95588a2324e0d0f9673f3fa6bab855b22c091b67658b6e11f0141455f1ad360");
        nDefaultPort = 40002;
        ...
        nZerocoinStartTime = 1544919134; // 5 - Oct - 2018
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("045ddd11164366709349f9d9ec903697f3cdcfe3dd00a73638bc4b4a67bb3091ae4e461e4909bc2d5cb624feab771e330ae5799bdf372aa368c691251c9f1bd0de") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1544919134;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 436551;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x906a42e00da09beb034fa6d530091e506705bd87a630bdeac334f98e2db87b36"));
        assert(genesis.hashMerkleRoot == uint256("0x745b6167635c8e93b30af5c0be524fec7f97936346151859f73a1a952d7e1f30"));

    	vSeeds.push_back(CDNSSeedData("wallet.rtwcoin.com", "142.93.196.107"));             // seed1
        vSeeds.push_back(CDNSSeedData("explorer.rtwcoin.com", "142.93.246.46"));             // seed2
        vSeeds.push_back(CDNSSeedData("pool.rtwcoin.com", "142.93.82.93"));             // seed2
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 74); // W
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x40)(0x6a)(0x5a)(0xa1).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x40)(0x8a)(0x5a)(0x1a).convert_to_container<std::vector<unsigned char> >();
        // 	BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md 1135
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x70)(0x00)(0x2d)(0xfb).convert_to_container<std::vector<unsigned char> >();
	...
	strSporkKey = "045c784a8c93f69282bf9e4982582198f7bfcf232fb97ea269b3979c77504e4ee2a2b3bba39b53fffe19d50231cba6cea4252310d50e6194abe9103a47b0912478"; //since it's network from AriA no need change
        strObfuscationPoolDummyAddress = "aW3y7JyvbVXTv4sdMD1ZrowsBKU8oHc7xn"; //disable future
