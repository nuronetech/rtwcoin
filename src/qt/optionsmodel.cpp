...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::AriA);
    ...
    if (!settings.contains("nAnonymizeAriAAmount"))
        settings.setValue("nAnonymizeAriAAmount", 1000);
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in aria.cpp during shotdown to also remove the window positions
