...
/* AriA GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "AriA"
#define QAPP_ORG_DOMAIN "aria.cash"
#define QAPP_APP_NAME_DEFAULT "AriA-Qt"
#define QAPP_APP_NAME_TESTNET "AriA-Qt-testnet"
