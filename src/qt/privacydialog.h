...
public:
    ...
    void setZAriAControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzAriA_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzAriA_clicked();
    void on_pushButtonZAriAControl_clicked();
