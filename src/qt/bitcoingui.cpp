                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("AriA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AriA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and aria: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zARA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AriA Core"), this);
    aboutAction->setStatusTip(tr("Show information about AriA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AriA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AriA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AriA addresses"));
    ...
    openAction->setStatusTip(tr("Open a aria: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AriA Core help message to get a list with possible AriA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("AriA Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AriA network", "", count));
}
...
{
    QString strTitle = tr("AriA Core"); // default title
