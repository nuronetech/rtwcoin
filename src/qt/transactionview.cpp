 ...
 */
    ...
    typeWidget->addItem(tr("Received ARA from zARA"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zARA"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zAriA));
