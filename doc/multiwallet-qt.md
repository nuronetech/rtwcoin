...
In order to support loading of multiple wallets in aria-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is aria.cpp.
...
Changes to aria.cpp
----------------------
aria.cpp is the entry point into aria-qt, and as such, will require some minor modifications to provide hooks for
