Contributing to AriA Core
============================

The AriA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AriA Core project, and is not to be
confused with overall AriA Network Protocol consensus changes.

Whether a pull request is merged into AriA Core rests with the project merge
...
Patches that change AriA consensus rules are considerably more involved than
...
Where a patch set proposes to change the AriA consensus, it must have been
...
The project leader is the release manager for each AriA Core release.
